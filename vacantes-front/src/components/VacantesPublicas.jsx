...
const VacantesPublicas = () => {
  ...
  const aplicar = async (e) => {
    ...
    try {
      ...
      let idPersona = data.data.insertId || data.person_id;
  ...
  if (error) {
    return <div>Error al cargar las vacantes</div>;
  }
                ...
                <div className="card-body d-flex flex-row">
                  <div className="flex-grow-1">
                    ...
                    <p className="card-text">
                      <img src={`data:image/png;base64,${item.logo}`} width={24} alt="logo" />{" "}{item.company}
                      {" "}
