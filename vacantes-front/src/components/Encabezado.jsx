          ...
          <ul className="nav me-auto">
            <li style={{ marginRight: "20px" }} className="nav-item">
              <Link to="/" className="d-flex align-items-center mb-3 mb-lg-0 me-lg-auto link-body-emphasis text-decoration-none">
                <img src="./../public/dasc.png" className="bi me-2" width="90" height="32" />
              </Link>
            </li>
          ...
          <ul className="nav">
            {
              user !== undefined ? (
                ...
                <>
                  ...
                  <li className="nav-item"><Link to='/preRegistro' className="nav-link link-dark px-2">Registro</Link></li>
                </>
              )
            }
          </ul>
